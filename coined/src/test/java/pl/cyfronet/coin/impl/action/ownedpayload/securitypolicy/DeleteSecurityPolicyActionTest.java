...
import pl.cyfronet.coin.impl.action.ownedpayload.DeleteOwnedPayloadActionTest;
import pl.cyfronet.coin.impl.action.ownedpayload.MethodProvider;

/**
 * @author <a href="mailto:mkasztelnik@gmail.com">Marek Kasztelnik</a>
 */
public class DeleteSecurityPolicyActionTest extends
		DeleteOwnedPayloadActionTest {
