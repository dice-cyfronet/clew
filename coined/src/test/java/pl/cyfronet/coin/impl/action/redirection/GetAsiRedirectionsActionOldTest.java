...
@Deprecated
public class GetAsiRedirectionsActionOldTest extends ActionTest {
	...
	private void givenAsiRedirectionsInAIR() {
		...
		vm1.setConfiguration(INIT_CONF_ID);
	...
	private void whenGetAsiRedirections() {
		Action<List<Redirection>> action = actionFactory
				.createGetAsiRedirectionsActionOld(CTX_ID, USERNAME, ASI_ID);
