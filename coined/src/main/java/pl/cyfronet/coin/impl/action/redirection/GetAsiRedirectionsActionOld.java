 ...
 */
@Deprecated
public class GetAsiRedirectionsActionOld extends
		ReadOnlyAirAction<List<Redirection>> {

	private static final Logger logger = LoggerFactory
			.getLogger(GetAsiRedirectionsActionOld.class);
	...
	public GetAsiRedirectionsActionOld(ActionFactory actionFactory,
