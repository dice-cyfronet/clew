 ...
 */
public class GetOwnedPayloadPayloadAction extends OwnedPayloadAction<String> {

	private String ownedPayloadName;
	private OwnedPayloadActions actions;

	public GetOwnedPayloadPayloadAction(OwnedPayloadActionFactory actionFactory,
